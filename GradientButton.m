...
- (void)useSafariStyle
{
    [self setImage:[UIImage imageNamed:[[self class] resolveImageResource:@"YouTubeView.bundle/compass"]] forState:UIControlStateNormal];
}

- (void)useRefreshStyle
{
    [self setImage:[UIImage imageNamed:[[self class] resolveImageResource:@"YouTubeView.bundle/but_refresh"]] forState:UIControlStateNormal];
}

- (void)useBackStyle
{
    [self setImage:[UIImage imageNamed:[[self class] resolveImageResource:@"YouTubeView.bundle/arrow_left"]] forState:UIControlStateNormal];
}

- (void)useForwardStyle
{
    [self setImage:[UIImage imageNamed:[[self class] resolveImageResource:@"YouTubeView.bundle/arrow_right"]] forState:UIControlStateNormal];
}
...
- (void)useWhiteStyle
{
    ...
    self.cornerRadius = 9.f;
    [self setTitleColor:[UIColor blackColor] forState:
        UIControlStateNormal];
    [self setTitleColor:[UIColor darkGrayColor] forState:
        UIControlStateHighlighted];
}   /* useWhiteStyle */
